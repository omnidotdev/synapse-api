...
CREATE INDEX "workspace_organization_id_index" ON "workspace" USING btree ("organization_id");--> statement-breakpoint
CREATE UNIQUE INDEX "user_preference_id_index" ON "user_preference" USING btree ("id");--> statement-breakpoint
CREATE UNIQUE INDEX "user_preference_user_id_index" ON "user_preference" USING btree ("user_id");
