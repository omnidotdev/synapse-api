 ...
 *
 * Tracing is layered: this NodeSDK provides the OTLP export pipeline and the
 * global tracer provider; the GraphQL-layer `@envelop/opentelemetry` plugin in
 * server.ts then emits its spans through that same provider.
 *
